...
- Выбор языка (Swift или Objective-C) по договорённости или на усмотрение кандидата, если отдельной договоренности не было.
...
- Ограничений на используемые компоненты и библиотеки нет. В случае использования, их необходимо подключать через [CocoaPods](https://cocoapods.org/).
